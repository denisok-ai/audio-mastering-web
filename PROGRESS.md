...
|-----------|----------|----------|
| **Единый план доработок** | см. [doc/PLAN_DORABOTKI.md](doc/PLAN_DORABOTKI.md) | Очереди 1–13 выполнены (12: «Рекомендовать пресет», PRO-модули; 13: тарифы с токенами, мобильная шапка, лимиты загрузки). Дальнейшие задачи — по запросу. |
