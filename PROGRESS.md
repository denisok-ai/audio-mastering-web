...
|-----------|----------|----------|
| **Единый план доработок** | см. [doc/PLAN_DORABOTKI.md](doc/PLAN_DORABOTKI.md) | Очереди 1–12 выполнены (в т.ч. 12.1 «Рекомендовать пресет», 12.2 проверка PRO-модулей «Дополнительная обработка»). Дальнейшие задачи — по запросу. |
