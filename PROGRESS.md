...
> Обновлено: 2026-03-04 (очереди 1–4 плана доработок закрыты, добавлена очередь 5)  
...
|-----------|----------|----------|
| **Единый план доработок** | см. [doc/PLAN_DORABOTKI.md](doc/PLAN_DORABOTKI.md) | Очереди 1–7 выполнены (7: ссылки в README, дата в плане). |
| **План админ-панели** | см. [doc/PLAN_DORABOTKI_ADMIN.md](doc/PLAN_DORABOTKI_ADMIN.md) | Очереди 1–3 выполнены (выход, API-ключи, настройки, проверка LLM, пометка о перезапуске). |
| **Бэклог P57–P64** | **0** | Все 5 пунктов реализованы (AAC, метрики, i18n, пресеты сообщества, рефакторинг). |

**Итого:** основной план (P0–P64) выполнен. Очереди 1–7 плана доработок и план админ-панели (очереди 1–3) закрыты. Продукт готов к эксплуатации.
